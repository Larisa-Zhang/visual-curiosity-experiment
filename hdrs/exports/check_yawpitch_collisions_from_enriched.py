...
MODEL      = "Set_12_elong_glossy_3.glb"   # <--- change this to the object you want to test
ANGLE_RND  = 6                             # rounding decimals for yaw/pitch/roll
...
#   recovered_after_eulerZ_deg, recovered_after_eulerY_deg, recovered_after_eulerX_deg
YAW_COL   = "after_yaw"
